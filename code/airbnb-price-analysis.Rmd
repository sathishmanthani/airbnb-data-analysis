...
We can look at this data using different visual plots to understand it first. For e.g. Price by Room type using boxplot.  
Or Price by Neighbourhood Group using boxplot, Price distribution.  
How number of reviews is related to Price.  
How room availability is related to Price.  
...
Yes, like I said in the previous question - I would like to see Price using different dimensions like Room type, Neighbourhood, Number of reviews and Availability.  
New variables and joining dataframes maynot be needed for my analysis.  
